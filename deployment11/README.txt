# vedik — microWakeWord model
Downloaded from https://microwakeword.com

## What's in this ZIP
  vedik.tflite    — TFLite model (the trained wake word)
  vedik.json      — ESPHome manifest (points at the .tflite)

Keep both files together. The manifest references the .tflite
by relative path (./vedik.tflite); renaming or separating them
