# hey jarvis — microWakeWord model
Downloaded from https://microwakeword.com

## What's in this ZIP
  hey_jarvis.tflite    — TFLite model (the trained wake word)
  hey_jarvis.json      — ESPHome manifest (points at the .tflite)

Keep both files together. The manifest references the .tflite
by relative path (./hey_jarvis.tflite); renaming or separating them
...
## Tuning
Open hey_jarvis.json and edit the "micro" section:
