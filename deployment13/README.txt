# Hey nebule-on — microWakeWord model
Downloaded from https://microwakeword.com

## What's in this ZIP
  hey_nebule-on.tflite    — TFLite model (the trained wake word)
  hey_nebule-on.json      — ESPHome manifest (points at the .tflite)

Keep both files together. The manifest references the .tflite
by relative path (./hey_nebule-on.tflite); renaming or separating them
...
## Tuning
Open hey_nebule-on.json and edit the "micro" section:
