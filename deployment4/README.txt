# hello navi — microWakeWord model
Downloaded from https://microwakeword.com

## What's in this ZIP
  hello_navi.tflite    — TFLite model (the trained wake word)
  hello_navi.json      — ESPHome manifest (points at the .tflite)

Keep both files together. The manifest references the .tflite
by relative path (./hello_navi.tflite); renaming or separating them
...
## Tuning
Open hello_navi.json and edit the "micro" section:
