# vega — microWakeWord model
Downloaded from https://microwakeword.com

## What's in this ZIP
  vega.tflite    — TFLite model (the trained wake word)
  vega.json      — ESPHome manifest (points at the .tflite)

Keep both files together. The manifest references the .tflite
by relative path (./vega.tflite); renaming or separating them
